...
class AnimationSamplesActivity : AppCompatActivity() {
    ...
    private lateinit var icCommandRichPathView : RichPathView

    private lateinit var animalRichPathView : RichPathView
    private lateinit var icArrowSearchRichPathView : RichPathView
    private lateinit var icNotificationsRichPathView : RichPathView
    private lateinit var icPlaylistAddCheckRichPathView : RichPathView
    private lateinit var loveFaceRichPathView : RichPathView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_animation_samples)

        icCommandRichPathView = findViewById(R.id.icCommandRichPathView)
        animalRichPathView = findViewById(R.id.animalRichPathView)
        icArrowSearchRichPathView = findViewById(R.id.icArrowSearchRichPathView)
        icNotificationsRichPathView = findViewById(R.id.icNotificationsRichPathView)
        icPlaylistAddCheckRichPathView = findViewById(R.id.icPlaylistAddCheckRichPathView)
        loveFaceRichPathView = findViewById(R.id.loveFaceRichPathView)
